 ...
 * `roster_model`. These helpers just make the meatyboys-vs-OFDS distinction
 ...
 *
 *   meatyboys  (Super Rugby)  — an OPTIONAL club FRONT-ROW UNIT + flexible
...
const Leagues = {
  ...
  /** meatyboys-style: owns a club front-row unit + flexible composition. */
  isMeatyboys(model) { return !!(model && model.fr_unit); },
